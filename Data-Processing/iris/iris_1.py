...
class Bayes_Test():
    ...
    def cal_posteriori_probability(self, X, Y, p, means, vars):
        ...
        for i in range(len(X1)):
            ...
            # 计算判别函数，选取概率最大的类
            typeList = [P_1, P_2, P_3]
            resultList.append(typeList)
...
# 验证分类准确性--测试集
resultList = bayes.cal_posteriori_probability(X_train, Y_train, prior_p, means, vars)
bayes.pltList(resultList)
# 模板方法--性能对比
