...
trainset = tv.datasets.STL10(root='./data',  train=True, download=True,  transform=transform)
testset  = tv.datasets.STL10(root='./data',  train=False, download=True,  transform=transform)
